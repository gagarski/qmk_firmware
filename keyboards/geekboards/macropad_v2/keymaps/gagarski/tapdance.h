...
typedef struct top_level_user_data {
    uint16_t td_kc;
} top_level_user_data_t;
...
#define LAYERS_TD_TOP_LEVEL(td_kc_) \
    { .fn = {NULL, tap_dance_with_layers_finished, tap_dance_with_layers_reset}, .user_data = (void *)&((top_level_user_data_t){.td_kc = td_kc_}), }
